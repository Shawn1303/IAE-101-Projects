...
def sierpinski(degree, p1, p2, p3, color, line_width, screen):
    ...
    pMid1 = find_midpoint(p1, p2)
    pMid2 = find_midpoint(p1, p3)
    pMid3 = find_midpoint(p2, p3)
    color = (color + 1) % 4
    draw_triangle(pMid1, pMid2, pMid3, color, line_width, screen)
    if (degree != 0):
        sierpinski(degree-1, p1, pMid1, pMid2, color, line_width, screen)
        sierpinski(degree-1, pMid1, p2, pMid3, color, line_width, screen)
        sierpinski(degree-1, pMid3, pMid2, p3, color, line_width, screen)
